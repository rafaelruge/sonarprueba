...
@Component({
  selector: 'app-gestion-reactivosqce',
  templateUrl: './gestion-reactivosqce.component.html',
  styleUrls: ['./gestion-reactivosqce.component.css'],
  providers: [DatePipe]
})
export class GestionReactivosqceComponent implements OnInit {
  ...
  cargarGestionReactivos() {
    this.reactivosQceService.getAllAsync().then(respuesta => {
  ...
  crearEditarGestionReactivos() {
    if (!this.formaGestionReactivos.invalid) {
      ...
      if (this.accion === 'Crear') {
        ...
        this.reactivosQceService.create(this.formaGestionReactivos.value).subscribe(respuesta => {
          this.closeVentana();
          this.cargarGestionReactivos();
          ...
          this.reactivosQceService.createLogAsync(Loguser).then(respuesta => {
        ...
        this.reactivosQceService.update(this.formaGestionReactivos.value, this.formaGestionReactivos.value.idreagents).subscribe(respuesta => {
          this.closeVentana();
  ...
  actualizarEstadoGestionReactivos(datosReactivos) {
    ...
    this.reactivosQceService.update(datos, datosReactivos.idreagents).subscribe(respuesta => {
      this.cargarGestionReactivos();
      this.accion = 'Editar';
    });
  }
  ...
  eliminarGestionReactivos(id: any) {
    this.reactivosQceService.delete('Reagents', id).subscribe(respuesta => {
